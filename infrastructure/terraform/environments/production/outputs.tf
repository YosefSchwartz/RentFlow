# Production root — surface Foundation outputs.

output "name_prefix" {
  description = "Resource-name prefix for production (rentflow-production)."
  value       = module.foundation.name_prefix
}

output "common_tags" {
  description = "Standard tag set for production."
